        ...
        case "buy_gas_modal":
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="price" id="price" disabled class="form-control input-height" />
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-md-3">Total<span class="required"> * </span></label>
                    <div class="col-md-8">
                        <input type="text" name="total" id="total" disabled class="form-control input-height" />
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-8">
