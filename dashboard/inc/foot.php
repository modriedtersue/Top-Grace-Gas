...
<div class="page-footer">
    <div class="page-footer-inner"> <?php echo date('Y') ?> &copy Top Grace Gas By
        <a href="" target="" class="makerCss">N-Tech Systems LTD</a>
    </div>
...
<script src="../assets/customJs/jquery.validate.min.js"></script>
<script src="../assets/customJs/custom.js"></script>
<script src="../assets/customJs/toggle.js"></script>
<script src="../assets/customJs/inc.js"></script>
